    ...
    "
      >
        ...
        <div className="flex my-10 w-full mx-4">
          <div className="flex flex-col mr-10 w-1/6">
            ...
            <div className="mt-14 text-customLightTextColor">
              상품 이미지의 형식은 &quot;jpg/jpeg/png&quot;만 업로드 가능
            </div>
          </div>
        ...
        <div className="flex my-10 w-full min-h-[80px] ml-4">
          <h1 className="text-2xl font-semibold mt-3 mr-8">
        ...
        <div className="flex mt-10 mx-4 w-full">
          ...
          <div className="flex flex-1">
            ...
            <div className="flex flex-col">
              <TimeInput hourHandler={hourHandler} minuterHandler={minuterHandler} />
              <div
                className={clsx(
        ...
        <div className="flex w-full mt-5 mx-4">
          <h1 className="text-2xl font-semibold mr-10 w-[80px]">
            설명 <span className="text-red-500">*</span>
          </h1>
          <div className="w-full mx-14 text-lg">
            <textarea
              value={description}
