...
const Footer: React.FC = () => {
  return (
    <footer className="bg-customGray text-white py-10 px-36">
      <div className="flex flex-row">
        <Link href={"/"}>
          <h1 className="text-6xl  font-bold">AUCATION</h1>
        </Link>
        <div className="flex flex-col justify-between pl-44 text-xl h-24">
          <FootPtag>믿을 수 있는 경매거래</FootPtag>
          <FootPtag>자주 묻는 질문</FootPtag>
        </div>
        <div className="flex flex-col justify-between pl-40 text-xl h-24">
        ...
        <div className="flex flex-col justify-between pl-40 text-xl h-36">
