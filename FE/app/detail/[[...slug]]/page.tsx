    ...
    <div className="w-full  px-80 py-20" style={{ backgroundColor: "var(--c-white)" }}>
      ...
      <div className="mt-10">
        ...
        <h2 className="text-4xl font-bold">
          {dataList.auctionTitle}
        </h2>
        {dataList.auctionType}
      </div>
      {/* 경매자 프로필 및 경매참여 인원, 경매까지 시간 */}
      <div className="flex mt-10">
        <Image alt="profile" width={20} height={20} className="w-20 h-20 rounded-full" src={dataList.auctionOwnerPhoto} />

        <div className="ml-4 flex flex-col justify-center flex-1">
          <div>
            <h3 className="text-1xl font-thin text-black mb-1">{dataList.auctionOwnerMemberRole  == "SHOP" ? "소상공인" : "개인"}</h3>
          </div>
          <div>
      ...
      {/* 가격 버튼 */}
      <PriceBox startingPrice={dataList.auctionStartPrice} highestPrice={dataList.auctionTopPrice} bidUnit={dataList.auctionAskPrice} />
