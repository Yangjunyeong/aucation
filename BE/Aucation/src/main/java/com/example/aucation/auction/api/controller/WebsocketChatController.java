...
public class WebsocketChatController {
	...
	// /app/send/{crId}
	//옥션 페이지에 들어간다면
	@MessageMapping("/send/register/{auctionPK}")
	public void streamText(@Payload BIDRequest bidRequest, @AuthorizedVariable Long memberPk, @DestinationVariable("auctionPK") String auctionPK) {
	...
	// // 클라이언트가 경매
	// @PostMapping("/enter/{auctionPK}")
	// public void EnterAuctionRoom(@AuthorizedVariable Long memberPk, @PathVariable("auctionPK") String auctionPK
	// 										, @) {
	//
	// 	// 채팅 내용 Redis에 저장
